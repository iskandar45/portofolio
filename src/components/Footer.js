...
const Footer = () => {
  return (
    <footer className="bg-slate-200 py-2 px-8 w-full flex items-center justify-between">
      <div className="flex items-center justify-center">
        <p className="text-gray-600 mr-2">Made with</p>
        <a href="https://nextjs.org/" target="_blank" rel="noreferrer">
          <Image src={ICNextjs} width={60} alt="Next js" />
        </a>
      </div>
